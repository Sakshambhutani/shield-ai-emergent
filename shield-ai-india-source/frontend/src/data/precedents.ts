...
export const PRECEDENTS: Precedent[] = [
  ...
  { id: 'p-novi', country: 'Space', title: 'NOVI satellite: Hivemind on-orbit', type: 'Capability demonstration', lesson: 'Military-space autonomy is technically credible — a precedent, not a business.', claimIds: ['c-novi'] },
