...
// Keep stable area identifiers for saved links and records.
export const AREA_LABELS: Record<Area, string> = {
 Overview:'Overview', 'Business Development':'Business Development', Operations:'Programmes',
 Engineering:'Engineering', HR:'People and Culture', 'Finance and Legal':'Finance and Legal', 'JSW Partnership':'JSW Partnership',
};
...
export const OPPORTUNITIES: Opportunity[] = [
 ...
 { id: 'maritime', customer: 'Maritime service', project: 'Maritime ISR programme', segment: 'B2G', stage: 1, value: 80, close: '2028-01-31', decision: 'Confirm RFP planning window', due: '2026-10-30', owner: 'Government BD', risk: 'RFP timing', backed: false, route: 'Capital acquisition · standard', commitment: 'AoN-stage pursuit; no Shield award or evaluation commitment.' },
