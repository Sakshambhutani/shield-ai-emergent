...
export const SECTIONS: SectionDef[] = [
  ...
  { id: 'md', num: '08', label: 'MD Dashboard', path: '/md-dashboard', question: 'What needs attention now?', answer: 'Three bets, three decisions and six monitored red flags.', claimIds: ['m-md', 'm-integrations', 'c-jsw', 'c-army-select'] },
];
