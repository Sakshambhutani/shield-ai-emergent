...
export const SECTIONS: SectionDef[] = [
  ...
  { id: 'convergence', num: '03', label: 'Priorities', path: '/priorities', question: 'Which moves matter most?', answer: 'Three growth bets. Two execution enablers.', claimIds: ['m-scores', 'm-3bets', 'm-tactical-layer', 'm-male-layer', 'm-navy-pen', 'c-army-select', 'c-male', 'c-nsuas', 'c-cats', 'c-nrt', 'c-grse'] },
