...
export const SECTIONS: SectionDef[] = [
  ...
  { id: 'convergence', num: '03', label: 'Priorities', path: '/priorities', question: 'Which moves matter most?', answer: 'Three strategic bets. Two execution enablers.', claimIds: ['m-scores', 'm-3bets', 'm-tactical-layer', 'm-male-layer', 'm-navy-pen', 'c-army-select', 'c-male', 'c-nsuas', 'c-cats', 'c-nrt', 'c-grse'] },
  ...
  { id: 'kpis', num: '07', label: 'Scorecard', path: '/kpis', question: 'How are we performing against the plan?', answer: 'Actual now versus expected now.', claimIds: ['m-kpis', 'm-integrations', 'c-army-select', 'c-jsw', 'c-vision-australia'] },
  { id: 'md', num: '08', label: 'MD Dashboard', path: '/md-dashboard', question: 'What needs my attention now?', answer: 'Decisions and active exceptions only.', claimIds: ['m-md', 'm-integrations', 'c-jsw', 'c-army-select'] },
];
