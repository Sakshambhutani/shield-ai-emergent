...
export const SECTIONS: SectionDef[] = [
  ...
  { id: 'md', num: '07', label: 'MD Dashboard', path: '/md-dashboard', question: 'What must the MD decide this month?', answer: 'Monthly KPIs, decision requests, early warnings and accountable follow-through.', claimIds: ['m-md'] },
];
