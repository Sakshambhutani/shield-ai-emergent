...
export const SECTIONS: SectionDef[] = [
  ...
  { id: 'money', num: '01', label: 'Market', path: '/money', question: 'Where is demand heading?', answer: 'Money and modernisation are moving toward autonomy.', claimIds: ['c-budget-total', 'c-budget-capital', 'c-budget-acq', 'c-budget-domestic', 'c-budget-revenue', 'c-dap', 'c-nsuas', 'c-haps', 'c-cuas-aon', 'c-male', 'c-army-drones', 'c-cats', 'm-tactical-layer', 'm-male-layer'] },
  { id: 'buyers', num: '02', label: 'Accounts', path: '/buyers', question: 'Where can we win?', answer: 'A broad bottom-up opportunity universe across products, missions and platform cells.', claimIds: ['c-army-select', 'c-vbat', 'c-xbat', 'c-vidar', 'c-grse-platforms', 'c-bel-platforms', 'c-hal-platforms', 'c-hal-warrior-2026', 'c-bdl-ai', 'c-kssl-underwater', 'c-mdl-xlauv', 'c-newspace-incumbency', 'c-lt-incumbent', 'c-adani-incumbent', 'c-raphe-incumbency', 'c-ayaan-incumbency', 'c-paras-selective', 'm-account-postures', 'c-mhi', 'c-sg', 'c-tt', 'c-tracker-l3h'] },
