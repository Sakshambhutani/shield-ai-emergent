...
export const SECTIONS: SectionDef[] = [
  ...
  { id: 'buyers', num: '02', label: 'Opportunity Landscape', path: '/opportunities', question: 'How does the opportunity expand?', answer: 'From the Army foothold through adjacent direct and platform-led opportunities into future autonomy domains.', claimIds: OPPORTUNITY_CLAIM_IDS },
  ...
  { id: 'md', num: '07', label: 'MD Dashboard', path: '/md-dashboard', question: 'Are we selling, delivering and operating within capacity?', answer: 'Business performance, commercial momentum, functional execution and financial health.', claimIds: ['m-md'] },
];
