...
export const WORK_STAGES: WorkStage[] = [
  ...
  { id: 'sustain', name: 'SUSTAIN', owner: 'Programmes / Mission Success', support: 'Programmes · Industrialisation', decision: 'Support posture and improvement priority', kpis: ['Availability', 'Blocker ageing'] },
