...
export const OPERATING_CAPABILITIES: OperatingCapability[] = [
  ...
  { id: 'industrialisation', short: 'INDUSTRIAL', name: 'Supply Chain, Procurement & Industrialisation', owns: ['JSW execution interface and supplier readiness', 'Localisation, fulfilment, spares and sustainment'], notOwns: ['Global aircraft design authority', 'Unvalidated JSW sustainment scope'], interfaces: ['JSW', 'Global Aircraft Product', 'Supply Chain / Procurement'], kpis: ['Readiness gates', 'Supplier risk', 'Fulfilment', 'Sustainment readiness'], global: ['Aircraft / V-BAT / X-BAT', 'Global legal / export / security expertise'], claimIds: ['c-jsw', 'm-opmodel'] },
