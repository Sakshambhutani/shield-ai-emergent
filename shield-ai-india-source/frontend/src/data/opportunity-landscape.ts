...
export const OPPORTUNITY_ARENAS: OpportunityArena[] = [
  { id: 'army', title: 'Army ISR & Tactical Autonomy', route: 'direct', horizon: 'Now',
  ...
  { id: 'airforce', title: 'Air Force Swarm & Teaming', route: 'direct', horizon: 'Next',
  ...
  { id: 'defence-space', title: 'Defence Space Agency', route: 'direct', horizon: 'Future',
  ...
  { id: 'partner-maritime-isr', title: 'Maritime ISR', route: 'partner', horizon: 'Next',
    description: 'Maritime surveillance through partner platforms and sensing integrations.', shield: 'V-BAT + ViDAR',
    context: 'A platform-partner route to maritime ISR through aircraft, shipborne UAS and sensing integrations. This addresses the same underlying maritime demand as the direct government route, not an additional programme pool. Partner access, sensor compatibility and procurement eligibility require validation.',
    accounts: [], programmes: ['navy', 'coastguard'], claimIds: ['c-nsuas', 'c-rnln', 'c-vidar', 'c-vbat'] },
