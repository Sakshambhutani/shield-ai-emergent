...
export const BD_PLANNING_BASIS = 'Annual orders follow the workbook; pipeline targets follow it from FY26–27 onward. Assumed allocation: B2B 20%, B2G 70% (45% new service programmes + 25% Army expansion), PSUs 10%. Assumed closure counts: 7 / 14 / 28 in FY26–27 / FY27–28 / FY28–29. These are planning workstreams, not named opportunities or actual wins. FY25–26 uses the model’s initial ₹200 Cr Army order baseline; the user sets FY25–26 pipeline to ₹200 Cr and treats the initial ₹200 Cr order as closed for that year. Later-year closed orders have not been supplied.';
const LANES = [
