...
export const MONTHLY_REVIEWS = [
  { id: '2026-08', period: 'August 2026', updated: '03 Sep 2026 · 12:00 IST', prior: 'July', rows: [
    { label: 'Revenue', review: 0.8, plan: 0.9, prior: 0.65, owner: 'Programmes + Finance', note: 'Assumed accepted integration and support scope; separate from the long-term Army scenario.' },
    { label: 'New bookings', review: 1.5, plan: 1.8, prior: 1.2, owner: 'BD + Commercial', note: 'Assumed incremental paid integration and support orders; excludes rebooking the anchor award.' },
    { label: 'Collections', review: 0.72, plan: 0.85, prior: 0.6, owner: 'Finance', note: 'Assumed customer receipts against integration and support invoices.' },
    ...
    { label: 'Programme delivery payments', review: 0.52, plan: 0.585, prior: 0.4225, owner: 'Programmes + Finance', note: 'Assumed programme-level delivery charges for integration and support, including global product and engineering allocations; not JSW procurement or a confirmed Shield India payable. June includes an assumed anchor mobilisation charge.' },
    { label: 'Operating contribution', review: 0.06, plan: 0.11, prior: 0.0175, owner: 'Finance', note: 'Assumed revenue less 65% matched delivery cost and local operating cost; programme payment timing is separate.' },
  ] },
  { id: '2026-07', period: 'July 2026', updated: '04 Aug 2026 · 12:00 IST', prior: 'June', rows: [
    { label: 'Revenue', review: 0.65, plan: 0.7, prior: 0.55, owner: 'Programmes + Finance', note: 'Assumed accepted integration and support scope; separate from the long-term Army scenario.' },
    { label: 'New bookings', review: 1.2, plan: 1.4, prior: 1, owner: 'BD + Commercial', note: 'Assumed incremental paid integration and support orders; excludes rebooking the anchor award.' },
    { label: 'Collections', review: 0.6, plan: 0.65, prior: 0.5, owner: 'Finance', note: 'Assumed customer receipts against integration and support invoices.' },
    ...
    { label: 'Programme delivery payments', review: 0.4225, plan: 0.455, prior: 2.6, owner: 'Programmes + Finance', note: 'Assumed programme-level delivery charges for integration and support, including global product and engineering allocations; not JSW procurement or a confirmed Shield India payable. June includes an assumed anchor mobilisation charge.' },
    { label: 'Operating contribution', review: 0.0175, plan: 0.04, prior: -0.0125, owner: 'Finance', note: 'Assumed revenue less 65% matched delivery cost and local operating cost; programme payment timing is separate.' },
  ] },
];

export const REVIEW_ASSUMPTIONS = [
  { label: 'JSW and Shield responsibility split', basis: 'Planning assumption: JSW owns production, factory investment and production supplier procurement. Shield India coordinates technology transfer, integration, acceptance support and partner dependencies, and manages its own people and overhead budget. The financial review is an India-facing programme case, not a Shield India legal-entity cash ledger. The 65% delivery-cost allowance and $1.56M 13-week programme payments represent assumed global product, engineering and delivery charges; they do not establish an obligation for Shield India to fund JSW suppliers. Finance and HQ must assign the payer before using the programme cash case as an India funding request.' },
  ...
  { label: '13-week cash headroom', basis: 'Opening cash $2M + receipts $2.2M − programme delivery payments $1.56M − local costs $0.66M = closing and assumed minimum cash $1.98M. Assumed planning floor $0.5M; minimum headroom $1.48M. Assume receipts precede outflows each week; Finance owns the weekly phasing.' },
