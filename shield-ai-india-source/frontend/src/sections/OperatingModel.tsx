...
export default function OperatingModel() {
  ...
  return <Screen>
     <Headline title="Three missions. One India operating system." sub="Mission owners coordinate the capabilities they consume; India pulls from global centres without recreating them." right={<SourceButton claimIds={['m-opmodel', 'c-india-sub', 'c-vision-australia']} title="Operating model" />} />
